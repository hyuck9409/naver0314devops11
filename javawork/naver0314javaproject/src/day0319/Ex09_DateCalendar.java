...
public class Ex09_DateCalendar {
	...
	public static void main(String[] args) {
		...
		//Date 클래스를 이용해서 년,월,일,시,분,초 얻기(JDK1.1 이후 Deprecate 되고 Calendar를 권장하나 여전히 많이 사용중
		...
		Calendar cal=Calendar.getInstance();//생성자가 public 이 아니라서 new로 생성불가
		//퍼블릭이 아닌건 new로 생성이 불가능함 ex) Calendar
