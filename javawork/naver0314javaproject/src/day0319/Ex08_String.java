...
public class Ex08_String {
	...
	public static void main(String[] args) {
		...
		System.out.println(str1.toUpperCase());//모두 대분자로 변환해서 반환
		...
		System.out.println(str1.toLowerCase().endsWith("day"));//str1 을 소문자로 변한 day로 끝나는지 비교 : true
		...
		String msg="  hello  ";
		System.out.println(msg.length());//9글자 공백때문에!
		System.out.println(msg.trim().length());//양쪽 공백 제거후 5글자
		
		//valueOf : 어떤 타입의 데이터든지 모두 String 으로 변환해준다
		System.out.println(String.valueOf(3));//정수 3이 문자열 "3"으로 변환
		System.out.println(3+"");//이 방법도있음
